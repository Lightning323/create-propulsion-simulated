...
public class PlatinumFluidTankCTBehaviour extends HorizontalCTBehaviour {
    private final CTSpriteShiftEntry innerShift;

    public PlatinumFluidTankCTBehaviour(CTSpriteShiftEntry layerShift, CTSpriteShiftEntry topShift, CTSpriteShiftEntry innerShift) {
